...
def generate_adversarial_examples(FLAG, ATTACK, eps, X_train, X_test, y_train, y_test, X_train_bb, y_train_bb, mapping, clf=None, mask=None, mode='attack'):
    if FLAG == 'wb':
        ...
        res = clf.generate_adv(ATTACK, X_test, eps, mask)
    elif FLAG == 'wb_kernel':
        res = clf.generate_adv(X_test, y_test, eps, mask)
